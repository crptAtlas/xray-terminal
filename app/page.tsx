...
const HOW = [
  ...
  { n: "05", name: "SORTER", sub: "bands the holders", body: 'holders grouped by pnl, five points wide, at most three groups - so you read "31% of supply sits at +40..45% pnl".', line: <><span style={{ color: "var(--profit)" }}>31.2%</span> supply · pnl +40..45 · 188 wallets &nbsp; <span style={{ color: "var(--neutral)" }}>22.9%</span> · pnl +6..11 · 302 &nbsp; <span style={{ color: "var(--loss)" }}>18.4%</span> · pnl −15..−10 · 553</> },
